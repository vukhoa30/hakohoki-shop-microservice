import { request, parseToQueryString, delay, alert, createSocketConnection } from '../utils'
...
function loadPromotion() {
    ...
    return async dispatch => {
        ...
        try {
            ...
            if (status === 200)
                return dispatch(getAction(PROMOTION_LOADED, { list: data.map(promotion => ({ ...data, mainPicture: data.products[0].mainPicture })) }))
