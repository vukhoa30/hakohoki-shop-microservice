...
class TabBarIcon extends Component {
    ...
    render() {
        ...
        switch (routeName) {
            ...
            case 'Home':
                icon = <Icon name={focused ? 'ios-home' : 'ios-home-outline'} style={styles.icon} />
                break
            case 'Profile':
                icon = <Icon name={focused ? 'ios-person' : 'ios-person-outline'} style={styles.icon} />
                break
            case 'List':
                icon = <Icon name={focused ? 'ios-list-box' : 'ios-list-box-outline'} style={styles.icon} />
                break
            case 'Notification':
                icon = <Icon name={focused ? 'ios-notifications' : 'ios-notifications-outline'} style={styles.icon} />
                break
            default:
                icon = <Icon name='ios-information-circle-outline' style={styles.icon} />
