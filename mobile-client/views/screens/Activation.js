...
class Activation extends Component {
  ...
  componentDidUpdate() {
    ...
    if (submitSucceeded) {
      ...
      saveToBuffer({ emailOrPhoneNo: navigation.state.params.emailOrPhoneNo });
      navigation.goBack()
        ...
        <Content>
          <View style={{ marginHorizontal: 10, marginVertical: 20 }}>
            <Image
              ...
              source={{
                uri:
                  "https://cdn4.iconfinder.com/data/icons/meBaze-Freebies/512/unlock.png",
                width: 100,
                height: 100
              }}
            />
          ...
          <AppButton
            ...
            block
            bordered
            onPress={handleSubmit(activate.bind(this))}
